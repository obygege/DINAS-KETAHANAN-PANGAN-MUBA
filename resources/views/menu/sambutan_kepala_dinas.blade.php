    ...
    <section>
      <div class="container" style="display: flex; flex-wrap: wrap;">
        ...
        <div style="flex: 2; min-width: 300px; padding-right: 20px; border: 2px solid black;"
          data-aos="fade-up">
          <h2 style="text-align: center; font-weight: bold; margin-top: 5%;">SAMBUTAN KEPALA DINAS</h2>
          <p style="text-align: justify; margin-top: 20px; margin-left: 35px; padding-right: 20px;">
            Bismillahirrahmanirrahim,
            Assalamu'alaikum Warahmatullahi Wabarakatuh,
            Selamat pagi, dan salam sejahtera bagi kita semua. Kami mengucapkan puji syukur kepada Allah SWT, karena atas rahmat dan karunia-Nya, kita diberikan kesempatan untuk terus bekerja keras dalam menjaga dan meningkatkan ketahanan pangan di wilayah kita. Pada kesempatan ini, saya ingin mengucapkan terima kasih kepada seluruh pihak yang telah berkontribusi dalam upaya mewujudkan ketahanan pangan yang lebih baik, berkelanjutan, dan merata. Sebagai Kepala Dinas Ketahanan Pangan, kami menyadari bahwa ketahanan pangan adalah kunci utama dalam mewujudkan kesejahteraan masyarakat. Kami terus berupaya untuk memastikan seluruh masyarakat dapat mengakses pangan yang cukup, bergizi, dan aman.
          </p>

          <p style="text-align: justify; margin-left: 35px; padding-right: 20px;">
            Melalui berbagai program dan kebijakan yang kami jalankan, kami berharap dapat memperkuat kerjasama antara pemerintah, masyarakat, dan sektor swasta. Kami yakin bahwa melalui kolaborasi yang baik, kita dapat menghadapi tantangan yang ada dan memastikan pangan yang berkelanjutan bagi generasi mendatang. Kami mengajak Anda semua untuk terus mendukung dan berpartisipasi dalam upaya besar ini. Bersama-sama, kita bisa mewujudkan ketahanan pangan yang lebih baik di daerah kita tercinta. Terima kasih atas perhatian dan dukungannya. Mari terus berinovasi dan bergerak maju untuk masa depan ketahanan pangan yang lebih baik. Wassalamu'alaikum Warahmatullahi Wabarakatuh.
          </p>
