    ...
    <section>
      <div class="container" style="display: flex; flex-wrap: wrap;">
        ...
        <div style="flex: 2; min-width: 300px; padding-right: 20px; border: 2px solid black;"
          data-aos="fade-up">
          <h2 style="text-align: center; font-weight: bold; margin-top: 5%;">STRUKTUR ORAGANISASI</h2>

          <img src="assets/img/STRUKTUR-ORGANISASI-DKP-MUBA-2021-1024x730.jpg" alt="Dasar Hukum" style="display: block; margin-top: 20px; margin-left: 35px; padding-right: 20px; width: 90%; height: auto;">
