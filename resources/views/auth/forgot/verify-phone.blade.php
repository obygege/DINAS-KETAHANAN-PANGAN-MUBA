...
<head>
    <meta charset="UTF-8">
    <title>Lupa Password - Verifikasi No. HP</title>
            ...
            <div class="col-md-8 col-lg-6 col-xl-5">
                <div class="form-container">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-muted">Langkah 2: Masukkan No. HP Anda.</p>
                    </div>
                    <form action="{{ route('password.verify.phone') }}" method="POST">
                        @csrf
                        {{-- Input tersembunyi untuk membawa ID user yang terenkripsi --}}
                        <input type="hidden" name="user_id" value="{{ $encryptedId }}">
                        <div class="mb-3">
                            <label for="no_hp" class="form-label">No. HP</label>
                            <input type="text" class="form-control" id="no_hp" name="no_hp" placeholder="Masukkan No. HP terdaftar" required>
                        </div>
                        <div class="d-grid pt-3">
                            <button type="submit" class="btn btn-register">Verifikasi & Lanjutkan</button>
                        </div>
                    </form>
                </div>
            </div>
